  ...
  <file name="index.html">
    <div ng-controller="TabsDemoCtrl">
      ...
      <tabset>
        ...
        <tab select="alertMe()">
          <tab-heading><i class="glyphicon glyphicon-bell"></i> Alert me!</tab-heading>
...
<example module="ui.bootstrap">
  <file name="index.html">
    <tabset>
      ...
      <tab>
        <tab-heading><i class="glyphicon glyphicon-heart"></i> glyphicon glyphicon heading?!?</tab-heading>
        That's right.
      </tab>
    </tabset>
  </file>
